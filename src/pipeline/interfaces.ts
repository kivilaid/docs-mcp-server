...
/**
 * Common interface that both PipelineManager and future PipelineClient will implement.
 * This ensures consistent API between embedded and external pipeline management.
 */
export interface IPipeline {
  ...
  updateJobProgress(job: PipelineJob, progress: ScraperProgress): Promise<void>;
}
